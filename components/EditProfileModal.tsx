...
interface EditProfileModalProps {
  ...
  onSubmit: (name: string, avatar: string, status: string) => Promise<void>;
  onCancel: () => void;
...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
  ...
  const {
    ...
    defaultValues: {
      name: initialData.name || storedFormData.name || '',
      avatar: initialData.avatar || storedFormData.avatar || AVATARS[0],
      status: initialData.status || storedFormData.status || STATUSES[0],
    },
  });
